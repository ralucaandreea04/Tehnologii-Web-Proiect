...
// Obținem toate nominalizările fiecărui actor
$sql = "SELECT id, full_name, LEFT(year, 4) AS year FROM $table WHERE LENGTH(full_name) > 0";
$result = $conn->query($sql);

$actors_by_year = array();

// Structurăm actorii într-un array multidimensional pe baza anilor
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Adăugăm actorul în array-ul pentru anul respectiv
